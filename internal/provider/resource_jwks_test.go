		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("hydra_jwks.generated", "key.#", "2"),
					resource.TestCheckResourceAttr("hydra_jwks.generated", "key.0.alg", "RS256"),
					resource.TestCheckResourceAttr("hydra_jwks.generated", "key.0.kid", "public:generated"),
					...
					resource.TestCheckResourceAttr("hydra_jwks.generated", "key.1.alg", "RS256"),
					resource.TestCheckResourceAttr("hydra_jwks.generated", "key.1.kid", "private:generated"),
					resource.TestCheckResourceAttr("hydra_jwks.generated", "key.1.use", "sig"),
					resource.TestCheckResourceAttrSet("hydra_jwks.generated", "key.1.n"),
					resource.TestCheckResourceAttrSet("hydra_jwks.generated", "key.1.d"),
				),
			},
		},
	})
